...
#define JAVA_C_CHAR_ARRAY_COPY_BACK(INPUT, SIZE) char* INPUT_temp_buffer = java_byte_array_to_char_array(env, INPUT_buffer); memcpy(INPUT_buffer, INPUT_temp_buffer, SIZE); safe_release_byte_array_elements(env, INPUT_buffer, (signed char *) INPUT_temp_buffer);
